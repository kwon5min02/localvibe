...
from app.modules.search import recommend as recommend_core
from app.modules.search.preferences import (
...
from app.modules.search.themes import TripThemeProfile
...
def _apply_trip_schedule(
    ...
    try:
        from app.modules.chat.planner import build_trip_schedule
